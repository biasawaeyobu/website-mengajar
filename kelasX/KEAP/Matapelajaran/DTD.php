...
// Ambil jurnal untuk kelas X
$sql = "SELECT * FROM jurnal WHERE kelas='X TOI' ORDER BY tanggal DESC";
        ...
        <table>
            ...
            if (isset($_POST['submit'])) {
                ...
                $insert = "INSERT INTO jurnal (kelas, mata_pelajaran, tanggal, materi, kegiatan, evaluasi) 
                           VALUES ('X TOI', '$mata_pelajaran', '$tanggal', '$materi', '$kegiatan', '$evaluasi')";
                mysqli_query($koneksi, $insert);
                header("Location: kelasX.php"); // refresh halaman setelah submit
            }
